...
package org.ricrdsson.torrent.service
...
import org.ricrdsson.torrent.rpc.statusString
import org.ricrdsson.torrent.torrentfile.rpc.Rpc
import org.ricrdsson.torrent.torrentfile.rpc.Server
import org.ricrdsson.torrent.torrentfile.rpc.ServerStats
import org.ricrdsson.torrent.ui.Settings
import org.ricrdsson.torrent.ui.torrentpropertiesfragment.TorrentPropertiesFragmentArgs
import org.ricrdsson.torrent.ui.utils.FormatUtils
...
class NotificationsController(private val context: Context) {
    ...
    object PersistentNotificationActions {
        const val CONNECT = "org.ricrdsson.torrent.ACTION_CONNECT"
        const val DISCONNECT = "org.ricrdsson.torrent.ACTION_DISCONNECT"
        const val SHUTDOWN_APP = "org.ricrdsson.torrent.ACTION_SHUTDOWN_APP"
    }
}
